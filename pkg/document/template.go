...
import (
	...
	"github.com/hugo19941994/helm-docs/pkg/util"
...
func getHelmDocsVersionTemplates() string {
	...
	versionSectionBuilder.WriteString("Autogenerated from chart metadata using [helm-docs v{{ .HelmDocsVersion }}](https://github.com/hugo19941994/helm-docs/releases/v{{ .HelmDocsVersion }})")
